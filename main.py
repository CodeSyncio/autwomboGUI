...
if __name__ == "__main__":
    ...
    mf.set_appearance_mode("System")
    customtkinter.set_appearance_mode("System") 
    customtkinter.set_default_color_theme("dark-blue")  
    mf.title('AI image webscraper - CodeSyncio')
    customtkinter.CTkLabel(mf, text='Prompt:',anchor=customtkinter.W,bg='gray').grid(row=0,sticky='w',column=0)
    customtkinter.CTkLabel(mf, text='Iterations:',anchor=customtkinter.W,bg='gray').grid(row=1,sticky='w',column=0)
    customtkinter.CTkLabel(mf, text='Style:',anchor=customtkinter.W,bg='gray').grid(row=2,sticky='w',column=0)
    customtkinter.CTkLabel(mf, text='folder name:',anchor=customtkinter.W,bg='gray').grid(row=3,sticky='w',column=0)
    customtkinter.CTkLabel(mf, text='webhook (optional):',anchor=customtkinter.NW,bg='gray').grid(row=5,sticky='w',column=0)
    display_text = customtkinter.StringVar()
    display_text.set(f">")
    out = customtkinter.CTkLabel(mf, textvariable=display_text,width=420,height=200,anchor=customtkinter.NW,wraplength=200,bg='darkgray').grid(row=6,column=1,sticky='w')
